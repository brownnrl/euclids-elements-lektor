...
- Text differences (first 5 passages):
  ...
  - Joyce: (missing)
    Ours:  a little modern algebra clarifies the situation we assume a b c d then if a b a is a numeric ratio then so is c d c it s simply because a b a c d c the lemma is the same as the lemma for proposition t…

### `content/elements/books/bookX/propositions/propX23/contents.lr` (vs `bookX/propX23.html`)

- Text similarity: **76.3%**
...
- Text differences (first 5 passages):
  ...
  - Joyce: is medial from this it is clear that an area commensurable with a medial area
    Ours:  (missing)
  - Joyce: (missing)
    Ours:  we can interpret this proposition numerically we defined a medial number in the guide to as being a number whose square is irrational but whose fourth power is a rational number then this proposition …
  - Joyce: guide we can interpret this proposition numerically we defined a medial number in the guide to as being a number whose square is irrational but whose fourth power is a rational number then this propos…
    Ours:  (missing)
...
- Text differences (first 5 passages):
  ...
  - Joyce: it has been proved in the arithmetical books that similar plane numbers have to one another the ratio which a square number has to a square number and that if two numbers have to one another the ratio…
    Ours:  (missing)
  - Joyce: (missing)
    Ours:  straight lines commensurable in length are always commensurable in square also but those commensurable in square are not always also commensurable in length and it is clear from what has been proved t…

### `content/elements/books/bookIV/propositions/propIV15/contents.lr` (vs `bookIV/propIV15.html`)

- Text similarity: **82.4%**
- Joyce link count: 9, ours: 9
- Text differences (first 5 passages):
...
- Text differences (first 5 passages):
  ...
  - Joyce: guide
    Ours:  (missing)
  - Joyce: (missing)
    Ours:  and in like manner as in the case of the pentagon if through the points of division on the circle we draw tangents to the circle there will be circumscribed about the circle a fifteen angled figure wh…

### `content/elements/books/bookIV/propositions/propIV5/contents.lr` (vs `bookIV/propIV5.html`)

- Text similarity: **88.1%**
...
- Text differences (first 5 passages):
  ...
  - Joyce: 2 r
    Ours:  2r
  - Joyce: (missing)
    Ours:  and it is clear that when the center of the circle falls within the triangle the angle bac being in a segment greater than the semicircle is less than a right angle when the center falls on the straig…
...
- Text differences (first 5 passages):
  ...
  - Joyce: (missing)
    Ours:  we have three cases to consider and two of them are easy in one case nw mx but not ny mz
...
- Text differences (first 5 passages):
  ...
  - Joyce: from this it is clear that if a magnitude measures three magnitudes then it also measures their greatest common measure the greatest common measure can be found similarly for more magnitudes and the c…
    Ours:  (missing)
  - Joyce: (missing)
    Ours:  if a magnitude measures three magnitudes then it also measures their greatest common measure the greatest common measure can be found similarly for more magnitudes and the corollary extended from this…
...
- Text differences (first 5 passages):
  ...
  - Joyce: guide
    Ours:  (missing)
  - Joyce: (missing)
    Ours:  if in a circle a straight line cuts a straight line into two equal parts and at right angles then the center of the circle lies on the cutting straight line from this it is clear that if in a circle a…
...
- Text differences (first 5 passages):
  ...
  - Joyce: guide
    Ours:  (missing)
  - Joyce: (missing)
    Ours:  from this it is clear that the straight line drawn at right angles to the diameter of a circle from its end touches the circle
...
- `content/elements/books/bookI/commonnotions/cn1_5/contents.lr` (92%)
...
- `content/elements/books/bookI/definitions/defI15_18/contents.lr` (100%)
- `content/elements/books/bookI/definitions/defI19/contents.lr` (100%)
- `content/elements/books/bookI/definitions/defI2/contents.lr` (100%)
- `content/elements/books/bookI/definitions/defI20_21/contents.lr` (100%)
- `content/elements/books/bookI/definitions/defI22/contents.lr` (100%)
...
- `content/elements/books/bookI/definitions/defI4/contents.lr` (100%)
- `content/elements/books/bookI/definitions/defI5/contents.lr` (99%)
- `content/elements/books/bookI/definitions/defI6/contents.lr` (100%)
- `content/elements/books/bookI/definitions/defI7/contents.lr` (99%)
- `content/elements/books/bookI/definitions/defI8/contents.lr` (100%)
- `content/elements/books/bookI/definitions/defI9/contents.lr` (100%)
- `content/elements/books/bookI/postulates/post1/contents.lr` (100%)
- `content/elements/books/bookI/postulates/post2/contents.lr` (100%)
- `content/elements/books/bookI/postulates/post3/contents.lr` (100%)
- `content/elements/books/bookI/postulates/post4/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI1/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI10/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI11/contents.lr` (100%)
...
- `content/elements/books/bookI/propositions/propI14/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI16/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI17/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI18/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI19/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI2/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI20/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI21/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI22/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI23/contents.lr` (100%)
...
- `content/elements/books/bookI/propositions/propI26/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI27/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI28/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI29/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI3/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI30/contents.lr` (100%)
...
- `content/elements/books/bookI/propositions/propI33/contents.lr` (100%)
...
- `content/elements/books/bookI/propositions/propI36/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI37/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI38/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI39/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI4/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI40/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI41/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI42/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI43/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI44/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI45/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI46/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI47/contents.lr` (100%)
...
- `content/elements/books/bookI/propositions/propI8/contents.lr` (100%)
- `content/elements/books/bookI/propositions/propI9/contents.lr` (100%)
...
- `content/elements/books/bookII/propositions/propII11/contents.lr` (100%)
- `content/elements/books/bookII/propositions/propII12/contents.lr` (100%)
- `content/elements/books/bookII/propositions/propII13/contents.lr` (100%)
- `content/elements/books/bookII/propositions/propII14/contents.lr` (100%)
- `content/elements/books/bookII/propositions/propII2/contents.lr` (100%)
- `content/elements/books/bookII/propositions/propII3/contents.lr` (100%)
- `content/elements/books/bookII/propositions/propII5/contents.lr` (100%)
- `content/elements/books/bookII/propositions/propII6/contents.lr` (100%)
...
- `content/elements/books/bookIII/definitions/defIII1/contents.lr` (100%)
- `content/elements/books/bookIII/definitions/defIII10/contents.lr` (99%)
- `content/elements/books/bookIII/definitions/defIII11/contents.lr` (99%)
...
- `content/elements/books/bookIII/definitions/defIII6_9/contents.lr` (100%)
- `content/elements/books/bookIII/propositions/propIII10/contents.lr` (100%)
...
- `content/elements/books/bookIII/propositions/propIII17/contents.lr` (100%)
- `content/elements/books/bookIII/propositions/propIII18/contents.lr` (100%)
...
- `content/elements/books/bookIII/propositions/propIII22/contents.lr` (100%)
- `content/elements/books/bookIII/propositions/propIII23/contents.lr` (100%)
- `content/elements/books/bookIII/propositions/propIII24/contents.lr` (100%)
...
- `content/elements/books/bookIII/propositions/propIII29/contents.lr` (100%)
- `content/elements/books/bookIII/propositions/propIII3/contents.lr` (100%)
- `content/elements/books/bookIII/propositions/propIII30/contents.lr` (100%)
...
- `content/elements/books/bookIII/propositions/propIII9/contents.lr` (100%)
- `content/elements/books/bookIV/definitions/defIV1_7/contents.lr` (100%)
- `content/elements/books/bookIV/propositions/propIV1/contents.lr` (99%)
- `content/elements/books/bookIV/propositions/propIV10/contents.lr` (100%)
- `content/elements/books/bookIV/propositions/propIV11/contents.lr` (100%)
...
- `content/elements/books/bookIV/propositions/propIV14/contents.lr` (99%)
- `content/elements/books/bookIV/propositions/propIV2/contents.lr` (98%)
- `content/elements/books/bookIV/propositions/propIV3/contents.lr` (99%)
...
- `content/elements/books/bookIV/propositions/propIV7/contents.lr` (100%)
- `content/elements/books/bookIX/propositions/propIX1/contents.lr` (100%)
...
- `content/elements/books/bookIX/propositions/propIX16/contents.lr` (100%)
...
- `content/elements/books/bookIX/propositions/propIX2/contents.lr` (100%)
- `content/elements/books/bookIX/propositions/propIX21/contents.lr` (100%)
...
- `content/elements/books/bookIX/propositions/propIX28/contents.lr` (100%)
...
- `content/elements/books/bookIX/propositions/propIX32/contents.lr` (100%)
- `content/elements/books/bookIX/propositions/propIX33/contents.lr` (100%)
- `content/elements/books/bookIX/propositions/propIX34/contents.lr` (100%)
...
- `content/elements/books/bookIX/propositions/propIX6/contents.lr` (100%)
...
- `content/elements/books/bookV/definitions/defV4/contents.lr` (100%)
- `content/elements/books/bookV/propositions/propV1/contents.lr` (100%)
- `content/elements/books/bookV/propositions/propV10/contents.lr` (97%)
...
- `content/elements/books/bookV/propositions/propV13/contents.lr` (100%)
- `content/elements/books/bookV/propositions/propV14/contents.lr` (97%)
- `content/elements/books/bookV/propositions/propV15/contents.lr` (100%)
- `content/elements/books/bookV/propositions/propV16/contents.lr` (100%)
...
- `content/elements/books/bookV/propositions/propV19/contents.lr` (92%)
- `content/elements/books/bookV/propositions/propV2/contents.lr` (100%)
- `content/elements/books/bookV/propositions/propV20/contents.lr` (100%)
- `content/elements/books/bookV/propositions/propV21/contents.lr` (100%)
- `content/elements/books/bookV/propositions/propV22/contents.lr` (100%)
- `content/elements/books/bookV/propositions/propV23/contents.lr` (100%)
- `content/elements/books/bookV/propositions/propV24/contents.lr` (100%)
- `content/elements/books/bookV/propositions/propV25/contents.lr` (99%)
...
- `content/elements/books/bookV/propositions/propV8/contents.lr` (97%)
- `content/elements/books/bookV/propositions/propV9/contents.lr` (99%)
- `content/elements/books/bookVI/definitions/defVI1/contents.lr` (99%)
- `content/elements/books/bookVI/definitions/defVI2/contents.lr` (100%)
- `content/elements/books/bookVI/definitions/defVI3/contents.lr` (100%)
- `content/elements/books/bookVI/definitions/defVI4/contents.lr` (100%)
- `content/elements/books/bookVI/propositions/propVI1/contents.lr` (97%)
- `content/elements/books/bookVI/propositions/propVI10/contents.lr` (100%)
- `content/elements/books/bookVI/propositions/propVI11/contents.lr` (100%)
- `content/elements/books/bookVI/propositions/propVI12/contents.lr` (100%)
- `content/elements/books/bookVI/propositions/propVI14/contents.lr` (100%)
- `content/elements/books/bookVI/propositions/propVI15/contents.lr` (100%)
- `content/elements/books/bookVI/propositions/propVI16/contents.lr` (100%)
- `content/elements/books/bookVI/propositions/propVI17/contents.lr` (100%)
- `content/elements/books/bookVI/propositions/propVI18/contents.lr` (100%)
- `content/elements/books/bookVI/propositions/propVI2/contents.lr` (100%)
- `content/elements/books/bookVI/propositions/propVI20/contents.lr` (95%)
- `content/elements/books/bookVI/propositions/propVI21/contents.lr` (100%)
- `content/elements/books/bookVI/propositions/propVI22/contents.lr` (100%)
- `content/elements/books/bookVI/propositions/propVI24/contents.lr` (100%)
...
- `content/elements/books/bookVI/propositions/propVI30/contents.lr` (100%)
...
- `content/elements/books/bookVI/propositions/propVI4/contents.lr` (100%)
- `content/elements/books/bookVI/propositions/propVI6/contents.lr` (100%)
...
- `content/elements/books/bookVII/definitions/defVII15_19/contents.lr` (97%)
- `content/elements/books/bookVII/definitions/defVII1_2/contents.lr` (100%)
- `content/elements/books/bookVII/definitions/defVII21/contents.lr` (100%)
- `content/elements/books/bookVII/definitions/defVII22/contents.lr` (100%)
- `content/elements/books/bookVII/definitions/defVII3_5/contents.lr` (97%)
- `content/elements/books/bookVII/definitions/defVII6_10/contents.lr` (96%)
- `content/elements/books/bookVII/propositions/propVII1/contents.lr` (100%)
- `content/elements/books/bookVII/propositions/propVII10/contents.lr` (100%)
- `content/elements/books/bookVII/propositions/propVII11/contents.lr` (100%)
- `content/elements/books/bookVII/propositions/propVII12/contents.lr` (100%)
- `content/elements/books/bookVII/propositions/propVII13/contents.lr` (100%)
- `content/elements/books/bookVII/propositions/propVII14/contents.lr` (100%)
- `content/elements/books/bookVII/propositions/propVII15/contents.lr` (100%)
- `content/elements/books/bookVII/propositions/propVII16/contents.lr` (100%)
...
- `content/elements/books/bookVII/propositions/propVII19/contents.lr` (100%)
...
- `content/elements/books/bookVII/propositions/propVII22/contents.lr` (100%)
- `content/elements/books/bookVII/propositions/propVII23/contents.lr` (100%)
- `content/elements/books/bookVII/propositions/propVII24/contents.lr` (100%)
- `content/elements/books/bookVII/propositions/propVII25/contents.lr` (100%)
- `content/elements/books/bookVII/propositions/propVII26/contents.lr` (100%)
- `content/elements/books/bookVII/propositions/propVII27/contents.lr` (100%)
...
- `content/elements/books/bookVII/propositions/propVII37/contents.lr` (100%)
...
- `content/elements/books/bookVII/propositions/propVII5/contents.lr` (100%)
...
- `content/elements/books/bookVIII/propositions/propVIII1/contents.lr` (100%)
- `content/elements/books/bookVIII/propositions/propVIII10/contents.lr` (100%)
- `content/elements/books/bookVIII/propositions/propVIII11/contents.lr` (100%)
...
- `content/elements/books/bookVIII/propositions/propVIII14/contents.lr` (99%)
- `content/elements/books/bookVIII/propositions/propVIII15/contents.lr` (100%)
- `content/elements/books/bookVIII/propositions/propVIII16/contents.lr` (100%)
- `content/elements/books/bookVIII/propositions/propVIII17/contents.lr` (100%)
...
- `content/elements/books/bookVIII/propositions/propVIII22/contents.lr` (100%)
- `content/elements/books/bookVIII/propositions/propVIII23/contents.lr` (100%)
...
- `content/elements/books/bookVIII/propositions/propVIII26/contents.lr` (100%)
- `content/elements/books/bookVIII/propositions/propVIII27/contents.lr` (100%)
- `content/elements/books/bookVIII/propositions/propVIII3/contents.lr` (100%)
- `content/elements/books/bookVIII/propositions/propVIII4/contents.lr` (100%)
- `content/elements/books/bookVIII/propositions/propVIII6/contents.lr` (100%)
- `content/elements/books/bookVIII/propositions/propVIII7/contents.lr` (100%)
...
- `content/elements/books/bookX/definitions/defX.I/contents.lr` (100%)
...
- `content/elements/books/bookX/propositions/propX1/contents.lr` (98%)
- `content/elements/books/bookX/propositions/propX10/contents.lr` (100%)
...
- `content/elements/books/bookX/propositions/propX12/contents.lr` (100%)
- `content/elements/books/bookX/propositions/propX13/contents.lr` (100%)
- `content/elements/books/bookX/propositions/propX15/contents.lr` (100%)
...
- `content/elements/books/bookX/propositions/propX19/contents.lr` (97%)
- `content/elements/books/bookX/propositions/propX2/contents.lr` (100%)
...
- `content/elements/books/bookX/propositions/propX27/contents.lr` (100%)
- `content/elements/books/bookX/propositions/propX28/contents.lr` (100%)
...
- `content/elements/books/bookX/propositions/propX31/contents.lr` (100%)
...
- `content/elements/books/bookX/propositions/propX34/contents.lr` (99%)
- `content/elements/books/bookX/propositions/propX35/contents.lr` (99%)
- `content/elements/books/bookX/propositions/propX36/contents.lr` (99%)
- `content/elements/books/bookX/propositions/propX37/contents.lr` (100%)
- `content/elements/books/bookX/propositions/propX38/contents.lr` (100%)
- `content/elements/books/bookX/propositions/propX39/contents.lr` (100%)
- `content/elements/books/bookX/propositions/propX40/contents.lr` (100%)
- `content/elements/books/bookX/propositions/propX41/contents.lr` (98%)
...
- `content/elements/books/bookX/propositions/propX44/contents.lr` (100%)
...
- `content/elements/books/bookX/propositions/propX5/contents.lr` (100%)
...
- `content/elements/books/bookX/propositions/propX7/contents.lr` (100%)
...
- `content/elements/books/bookX/propositions/propX73/contents.lr` (100%)
- `content/elements/books/bookX/propositions/propX74/contents.lr` (100%)
- `content/elements/books/bookX/propositions/propX75/contents.lr` (100%)
- `content/elements/books/bookX/propositions/propX76/contents.lr` (100%)
- `content/elements/books/bookX/propositions/propX77/contents.lr` (100%)
- `content/elements/books/bookX/propositions/propX78/contents.lr` (99%)
- `content/elements/books/bookX/propositions/propX79/contents.lr` (100%)
- `content/elements/books/bookX/propositions/propX8/contents.lr` (100%)
...
- `content/elements/books/bookXI/definitions/defXI11/contents.lr` (100%)
- `content/elements/books/bookXI/definitions/defXI12_13/contents.lr` (100%)
- `content/elements/books/bookXI/definitions/defXI14_17/contents.lr` (100%)
- `content/elements/books/bookXI/definitions/defXI18_20/contents.lr` (100%)
- `content/elements/books/bookXI/definitions/defXI1_2/contents.lr` (100%)
...
- `content/elements/books/bookXI/definitions/defXI25_28/contents.lr` (100%)
- `content/elements/books/bookXI/definitions/defXI3_5/contents.lr` (100%)
...
- `content/elements/books/bookXI/propositions/propXI10/contents.lr` (100%)
...
- `content/elements/books/bookXI/propositions/propXI13/contents.lr` (100%)
...
- `content/elements/books/bookXI/propositions/propXI2/contents.lr` (100%)
- `content/elements/books/bookXI/propositions/propXI20/contents.lr` (100%)
- `content/elements/books/bookXI/propositions/propXI21/contents.lr` (100%)
...
- `content/elements/books/bookXI/propositions/propXI25/contents.lr` (96%)
...
- `content/elements/books/bookXI/propositions/propXI28/contents.lr` (100%)
...
- `content/elements/books/bookXI/propositions/propXI39/contents.lr` (100%)
...
- `content/elements/books/bookXI/propositions/propXI6/contents.lr` (100%)
- `content/elements/books/bookXI/propositions/propXI7/contents.lr` (100%)
...
- `content/elements/books/bookXIII/propositions/propXIII1/contents.lr` (100%)
- `content/elements/books/bookXIII/propositions/propXIII10/contents.lr` (100%)
